...
async function createReview(req, res) {
    ...
    try {
        if (files.image) {
            reviewImage = await saveImages(
                files.image.length ? files.image : [files.image]
            )
        }
        ...
        return res
            ...
            .json(genResponse(review, null, true, null))
    } catch (err) {
...
async function deleteReview(req, res) {
    ...
    return res
        ...
        .json(
            genResponse(
                null,
                "cant delete the comment that you don't own",
                false,
                null
            )
        )
